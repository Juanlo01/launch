...
class MoveUp:
    ...
    def run_loop(self):
        while self.shared_memory_object.running.value:
            ...
            if self.shared_memory_object.iterations.value % 5 == 0:
            ...
            if (.05 - (end - start)) > .0:
                ...
                self.shared_memory_object.iterations.value

            # self.can.send_command() DO NOT SEND TWICE
